        ...
        <div className="relative flex items-center bg-white p-6 rounded-lg shadow-lg mt-10">
          ...
          <div className="w-1/2 h-[500px] flex flex-col justify-center items-center">
            {selectedB2B.companyLogo && (
              <img
              src={selectedB2B?.companyLogo?.replace("https://api.worldtriplink.com/uploads/", "")}
              alt="Company Logo"
          ...
          <div className="w-[28%] flex flex-col justify-start p-4 space-y-6 mt-10 ml-6">
            <div className="flex items-center space-x-4">
              ...
              {selectedB2B.govtApprovalCertificate ? (
                <button
                  ...
                  onClick={() => openModal("Govt Approval Certificate", selectedB2B.govtApprovalCertificate?.replace("https://api.worldtriplink.com/uploads/", ""))}
                >
                  Show Image
                </button>
              ) : (
            ...
            <div className="flex items-center space-x-4">
              ...
              {selectedB2B.companyDocs ? (
                <button
                  className="bg-black text-white py-2 px-4 rounded-lg hover:bg-gray-800"
                  onClick={() => openModal("Company Documents", selectedB2B.companyDocs?.replace("https://api.worldtriplink.com/uploads/", ""))}
                >
                  Show Image
                </button>
              ) : (
            ...
            <div className="flex items-center space-x-4">
              ...
              {selectedB2B.panDocs ? (
                <button
                  className="bg-black text-white py-2 px-4 rounded-lg hover:bg-gray-800"
                  onClick={() => openModal("PAN Documents", selectedB2B.panDocs?.replace("https://api.worldtriplink.com/uploads/", ""))}
                >
                  Show Image
                </button>
              ) : (
